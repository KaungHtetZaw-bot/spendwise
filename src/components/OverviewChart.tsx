...
const OverviewChart = () => {
  return (
    <div className="h-[300px] md:h-[400px] w-full py-4 px-2 md:p-6 rounded-3xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all">
      ...
      <div className="h-[220px] md:h-[300px]">
        <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={MOCK_CHART_DATA} margin={{ top: 0, right: 0, left: -30, bottom: 0 }}>
            <defs>
